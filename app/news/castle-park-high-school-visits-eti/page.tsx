...
export async function generateMetadata(): Promise<Metadata> {
  return pageMetadata(ROUTE, "Castle Park High School Visits ETI  - Electrical Training Institute", undefined);
}
...
<div className="uk-margin">
        <picture><img className="el-image" width="3000" height="1570" src={c.m("s.5.1.1.1.1.1.1.0.img", "/images/news/news250312.jpg")} alt={c.a("s.5.1.1.1.1.1.1.0.img", "High school girl gives the thumb's up at ETI")} /></picture>    
...
<h1 className="uk-h2 uk-margin-bottom uk-width-2xlarge uk-margin-auto">
                    ...
                    {c.t("s.7.1.1.1.1.h1", "Castle Park High School Visits ETI")}        
        
    
</h1><div className="uk-panel uk-text-meta uk-margin uk-width-2xlarge uk-margin-auto" data-cms-rich="" dangerouslySetInnerHTML={{ __html: c.r("s.7.1.1.1.2.div", "<time datetime=\"2025-03-12T11:44:50-07:00\">March 12, 2025</time> &nbsp; | &nbsp; <a href=\"/news\">News</a>") }} /><div className="uk-panel uk-margin uk-width-2xlarge uk-margin-auto"><p>{c.t("s.7.1.1.1.3.0.p", "Thank you Castle Park High School for visiting ETI and learning about the amazing benefits an IBEW and NECA apprenticeship has to offer!")}</p>
<p>{c.t("s.7.1.1.1.3.2.p", "Hope to see you all again!")}</p></div>
<nav className="uk-margin-medium-top uk-text-center">
    <ul className="uk-pagination uk-margin-remove-bottom uk-flex-center">
    
        
                        <li data-cms-rich="" dangerouslySetInnerHTML={{ __html: c.r("s.7.1.1.1.5.1.1.li", "<a href=\"/news/welcome-san-diego-building-trades-high-school-girls-boot-camp\"><span uk-pagination-previous></span> Prev</a>") }} />
...
<a className="el-link uk-icon-link" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fetiedu.org%2Fnews%2Fcastle-park-high-school-visits-eti" title="Tap here to share this page to Facebook." rel="noreferrer" target="_blank" aria-label="Tap here to share this page to Facebook."><span uk-icon="icon: facebook;"></span></a></li>
            <li className="el-item">
<a className="el-link uk-icon-link" href="https://x.com/intent/post?url=https%3A%2F%2Fetiedu.org%2Fnews%2Fcastle-park-high-school-visits-eti&text=" title="Tap here to share this page to X." rel="noreferrer" target="_blank" aria-label="Tap here to share this page to X."><span uk-icon="icon: x;"></span></a></li>
            <li className="el-item">
<a className="el-link uk-icon-link" href="https://bsky.app/intent/compose?text=Tap+here+to+share+this+page+to+Bluesky.%0Ahttps%3A%2F%2Fetiedu.org%2Fnews%2Fcastle-park-high-school-visits-eti" rel="noreferrer" target="_blank" aria-label="Bluesky"><span uk-icon="icon: bluesky;"></span></a></li>
            <li className="el-item">
<a className="el-link uk-icon-link" href="https://mastodon.social/share?url=https%3A%2F%2Fetiedu.org%2Fnews%2Fcastle-park-high-school-visits-eti&text=" title="Tap here to share this page to Mastodon." rel="noreferrer" target="_blank" aria-label="Tap here to share this page to Mastodon."><span uk-icon="icon: mastodon;"></span></a></li>
            <li className="el-item">
