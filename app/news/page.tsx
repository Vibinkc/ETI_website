...
export const generateMetadata = metadataFor(ROUTE, "News - Electrical Training Institute", undefined);
...
<NewsSidebar c={c} route={ROUTE} base="s.5.1.3.3" shareId="template-8aQccsbZ#0" latestId="template-8aQccsbZ#1" shareTag="h4" latestTitleClass="el-title uk-card-title" categoriesTitleClass="el-title" activeCategory={0} />
</div>
                                </div>                
</div>
  </>
