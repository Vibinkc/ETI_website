...
export async function generateMetadata(): Promise<Metadata> {
  return pageMetadata(ROUTE, "Inside Wireman - Electrical Training Institute", undefined);
}
...
<nav aria-label="Breadcrumb" className="uk-margin-small-bottom">
    <ul className="uk-breadcrumb uk-margin-remove-bottom" vocab="https://schema.org/" typeof="BreadcrumbList">
            ...
            <li property="itemListElement" typeof="ListItem">            <span property="name" aria-current="page">{c.t("s.5.1.1.1.1.1.5.1.span", "Inside Wireman")}</span>            <meta property="position" content="3" />
            </li>    
    </ul>
</nav>
...
<h1 className="uk-heading-medium uk-margin-large-bottom">
                    ...
                    {c.t("s.5.1.1.1.3.h1", "Inside Wireman")}        
        
    
</h1><div className="uk-panel uk-text-lead uk-margin uk-width-xlarge">{c.t("s.5.1.1.1.4.div", "The Inside Wireman Apprenticeship is a five-year training program that prepares individuals for careers as Journeyman electricians. Apprentices receive paid on-the-job training combined with classroom instruction, gaining the skills needed to install, maintain, and troubleshoot electrical systems in commercial and industrial settings.")}</div>
...
<div className="uk-flex-1 uk-flex uk-margin uk-visible@m">
        <picture><img className="el-image" style={{ aspectRatio: "auto" }} width="1200" height="1200" src={c.m("s.5.1.3.1.1.1.0.img", "/images/assets/heros/hero-bm02.jpg")} alt={c.a("s.5.1.3.1.1.1.0.img", "Electrician opening an electric panel.")} /></picture>    
