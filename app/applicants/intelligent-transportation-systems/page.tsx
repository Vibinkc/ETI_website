...
export async function generateMetadata(): Promise<Metadata> {
  return pageMetadata(ROUTE, "Intelligent Transportation Systems - Electrical Training Institute", undefined);
}
...
<nav aria-label="Breadcrumb" className="uk-margin-small-bottom">
    <ul className="uk-breadcrumb uk-margin-remove-bottom" vocab="https://schema.org/" typeof="BreadcrumbList">
            ...
            <li property="itemListElement" typeof="ListItem">            <span property="name" aria-current="page">{c.t("s.5.1.1.1.1.1.5.1.span", "Intelligent Transportation Systems")}</span>            <meta property="position" content="3" />
            </li>    
    </ul>
</nav>
...
<h1 className="uk-heading-medium uk-margin-large-bottom">
                    ...
                    {c.t("s.5.1.1.1.3.h1", "Intelligent Transportation Systems")}        
        
    
</h1><div className="uk-panel uk-text-lead uk-margin uk-width-xlarge">{c.t("s.5.1.1.1.4.div", "Build the systems that keep cities moving. The ITS Apprenticeship combines paid, hands-on training with classroom instruction, preparing you to work on traffic signals, fiber optics, and critical transportation infrastructure that supports safe and efficient travel.")}</div>
...
<div className="uk-flex-1 uk-flex uk-margin uk-visible@m">
        <picture><img className="el-image" style={{ aspectRatio: "auto" }} width="1200" height="1200" src={c.m("s.5.1.3.1.1.1.0.img", "/images/assets/heros/hero-bm03.jpg")} alt={c.a("s.5.1.3.1.1.1.0.img", "Electrician Trainee working a backhoe")} /></picture>    
