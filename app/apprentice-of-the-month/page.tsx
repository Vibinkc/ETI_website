...
export async function generateMetadata(): Promise<Metadata> {
  return pageMetadata(ROUTE, "Apprentice of the Month - Electrical Training Institute", undefined);
}
...
<div className="uk-h3 uk-visible@m">
                    ...
                    {c.t("s.5.1.3.3.1.2.1.1.1.1.div", "Share Us")}        
        
    
</div>
<div id="template-Fom_NwrK#0" className="uk-margin-small-top uk-text-center uk-visible@m">    <ul className="uk-child-width-auto uk-grid-small uk-flex-inline uk-flex-middle" uk-grid="">
            <li className="el-item">
<a className="el-link uk-icon-link" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fetiedu.org%2Fapprentice-of-the-month" title="Tap here to share this page to Facebook." rel="noreferrer" target="_blank" aria-label="Tap here to share this page to Facebook."><span uk-icon="icon: facebook;"></span></a></li>
            <li className="el-item">
<a className="el-link uk-icon-link" href="https://x.com/intent/post?url=https%3A%2F%2Fetiedu.org%2Fapprentice-of-the-month&text=" title="Tap here to share this page to X." rel="noreferrer" target="_blank" aria-label="Tap here to share this page to X."><span uk-icon="icon: x;"></span></a></li>
            <li className="el-item">
<a className="el-link uk-icon-link" href="https://bsky.app/intent/compose?text=Tap+here+to+share+this+page+to+Bluesky.%0Ahttps%3A%2F%2Fetiedu.org%2Fapprentice-of-the-month" rel="noreferrer" target="_blank" aria-label="Bluesky"><span uk-icon="icon: bluesky;"></span></a></li>
            <li className="el-item">
<a className="el-link uk-icon-link" href="https://mastodon.social/share?url=https%3A%2F%2Fetiedu.org%2Fapprentice-of-the-month&text=" title="Tap here to share this page to Mastodon." rel="noreferrer" target="_blank" aria-label="Tap here to share this page to Mastodon."><span uk-icon="icon: mastodon;"></span></a></li>
            <li className="el-item">
<a className="el-link uk-icon-link" href="https://www.linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Fetiedu.org%2Fapprentice-of-the-month" title="Tap here to share this page to LinkedIn." rel="noreferrer" target="_blank" aria-label="Tap here to share this page to LinkedIn."><span uk-icon="icon: linkedin;"></span></a></li>
...
<div className="uk-card uk-card-body uk-card-primary tm-child-list" id="template-Fom_NwrK#1">
...
<div className="uk-panel tm-child-list">
        <div className="el-title uk-h3">{c.t("s.5.1.3.3.1.3.1.3.1.1.1.div", "Categories")}</div>    
...
<li className="uk-active" data-cms-rich="" dangerouslySetInnerHTML={{ __html: c.r("s.5.1.3.3.1.3.1.3.1.1.3.5.li", "<a href=\"/apprentice-of-the-month\">\n        Apprentice of the Month            </a>") }} />
</ul>
